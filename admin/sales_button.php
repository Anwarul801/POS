        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					<?php
						$a=mysqli_query($conn,"select * from salesman where userid='".$cqrow['userid']."'");
						$b=mysqli_fetch_array($a);
					?>
                    <h5><center>SalesMan Name: <strong><?php echo ucwords($b['customer_name']); ?></strong></center></h5>
					<form role="form" method="POST" action="deletesalesman.php<?php echo '?id='.$cqrow['userid']; ?>">
                </div>
				</div>
    ...
    <div class="modal fade" id="edit_<?php echo $cqrow['userid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					<?php
						$a=mysqli_query($conn,"select * from salesman left join user on user.userid=salesman.userid where salesman.userid='".$cqrow['userid']."'");
						$b=mysqli_fetch_array($a);
					?>
					<div style="height:10px;"></div>
                    <form role="form" method="POST" action="edit_salesman.php<?php echo '?id='.$cqrow['userid']; ?>">
