        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
					...
					<center><h4 class="modal-title" id="myModalLabel">Purchase Details</h4></center>
                </div>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12">
							<span>SalesMan: <strong><?php echo ucwords($srow['customer_name']); ?></strong></span>
              ...
              <div class="row"> <!--Customer <section-->
                <input   id="amount" type="number" min="1" max="10000000" onchange="computeLoan()">
      <script>
...
<select class="form-control" id="sel1">
  ...
  ?>
                ...
                <div class="col-lg-2">
                  <input  id="interest_rate" type="number" min="0" max="100" value="10" step=".1" onchange="computeLoan()"
                   class="form-control">
                </div>
...
<option>Visa Card</option>
              ...
              <div class="col-lg-2">
                <div class="row">
                  <div class="col-lg-12">
                    <input  id="taka" type="number"   step=".1" onchange="computeLoan()"
                     class="form-control">
                  </div>
