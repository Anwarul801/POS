        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					...
					<form role="form" method="POST" action="deletecategory.php<?php echo '?categoryid='.$sqrow['categoryid']; ?>">
                </div>
				</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
                    ...
                    <form role="form" method="POST" action="edit_category.php<?php echo '?categoryid='.$sqrow['categoryid']; ?>">
