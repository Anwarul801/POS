<!-- Navigation -->
        <nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php"> <img style="display: inline-block; height: 40px; margin-top: -5px" src="../img/logo.png">
        SMART SALE SYSTEM
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    ...
                                    <a href="#"><span class="glyphicon glyphicon-user"></span> Users <span class="fa arrow"></span></a>
                                        ...
                                        <li>
                                            <a href="salesman.php"> <i class="fa fa-credit-card"></i>Customer  </a>
                                        </li>
                                        <li>
                                            <a href="supplier.php"> <i class="fa fa-truck"></i> Supplier</a>
                                        </li>
                                        <li>
                                            <a href="customer.php"> <i class="fa fa-credit-card"></i>SalesMan</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
